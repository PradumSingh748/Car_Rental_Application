...
int isValidDate(struct tm dt)
{
    ...
    if(dt.tm_year >= 2021 && dt.tm_year <= 2025)
    {
...
int returnCar()
{
    ...
    fclose(fp);
    fclose(fp1);
    updateCarCount2(R.car_id);   ////kdnbkdnknkdnknknknknknknknnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn
